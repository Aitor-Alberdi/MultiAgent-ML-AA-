...
bwrap_command = [
    ...
    "--setenv", "PATH", "/opt/conda/condabin:/opt/conda/envs/multiagent-ml-env/bin:/usr/bin:/bin",
    
    "--chdir", agent_run_path,
    "/opt/conda/envs/multiagent-ml-env/bin/python", "/repository/src/playground.py"
]
